  ...
  return (
    <div className="bg-black text-yellow-400 pt-10 text-justify font-redhead">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-yellow-500 mb-4">3. Sharing Your Information</h2>
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-yellow-500 mb-4">6. Third-Party Links</h2>
          <p className="leading-relaxed">
        ...
        <div className="mb-10">
          <h2 className="text-2xl font-semibold text-yellow-500 mb-4">7. Changes to This Policy</h2>
          <p className="leading-relaxed">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-yellow-500 mb-4">8. Contact Us</h2>
          <p className="leading-relaxed">
            If you have any questions about this Privacy Policy, please contact us at <a href="mailto:support@raamya.net.in" className="text-yellow-400 underline hover:text-yellow-300">support@raamya.net.in</a>.
          </p>
        </div>
      </div>
    </div>
