    ...
    <div className="bg-black text-yellow-400  pt-10 font-redhead">
      <div className="max-w-[1400px] text-justify mx-auto">
        ...
        <nav className="text-lg mb-8">
          ...
          <span className="text-yellow-400 font-bold ">About Us</span>
        </nav>

        {/* Main Title */}
        <h1 className="text-4xl sm:text-5xl font-bold text-yellow-400 mb-6 uppercase">
          About Us – Raamya ✨
        </h1>
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-semibold text-yellow-400 mb-4">It Girl</h2>
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-semibold text-yellow-400 mb-4">Girly Pop</h2>
          <div className="space-y-6 leading-relaxed">
            <p>
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-semibold text-yellow-400 mb-4">Street Chic</h2>
          <div className="space-y-6 leading-relaxed">
            <p>
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-semibold text-yellow-400 mb-4">Desi Diva</h2>
          <div className="space-y-6 leading-relaxed">
            <p>
        ...
        <div className="mb-10">
          <h2 className="text-3xl font-semibold text-yellow-400 mb-4">Bloom Girl</h2>
          <div className="space-y-6 leading-relaxed">
            <p>
        ...
        {/* Thank You Message */}
        <p className="font-bold text-yellow-400 mb-10 leading-relaxed">
